...
def main():
    ...
    parser.add_argument("--input", type=Path, default=Path("build/mobileclip-device-results"))
    parser.add_argument("--fixtures", type=Path, default=Path("build/mobileclip-device-benchmark/manifest.json"))
    parser.add_argument("--accuracy", type=Path, default=Path("build/mobileclip-accuracy/accuracy-results.json"))
