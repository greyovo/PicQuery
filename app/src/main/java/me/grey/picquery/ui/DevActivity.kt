...
//            println(output[0].contentToString())
        ...
        lifecycleScope.launch(Dispatchers.Main) {
            withContext(Dispatchers.Default) {
                ...
                for (i in 0..total) {
                    ...
                    saveBitMap(this@DevActivity, bitmap, "temp-224.jpg")
    ...
    private fun testImageSearcherEncode() {
        ...
        lifecycleScope.launch(Dispatchers.Default) {
            ...
            for (i in 1..batchSize) {
                tempBitmaps.add(loadThumbnail(this@DevActivity, imagePath))
            }
    ...
    private fun setImage(im: String) {
        ...
        imagePath = assetFilePath(this@DevActivity, selectedImage.value)
